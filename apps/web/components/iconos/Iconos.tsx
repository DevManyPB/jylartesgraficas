...
/**
 * Solo cuando quien lo usa no pasa clases. `cn` junta clases sin resolver
 * conflictos, así que con `h-5` fijo y un `h-4` del que llama, ganaba la que
 * el CSS genera después — `h-5` — y todo icono pedido más pequeño salía a
 * 20 px igualmente. Quien pase `className` tiene que incluir el tamaño.
 */
const TAMANO_POR_DEFECTO = "h-5 w-5";
