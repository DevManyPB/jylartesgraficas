 ...
 * producción el respaldo es `sas.jylartesgraficos.com`, el dominio que fija
 * AGENTS.md §1; `PANEL_URL` sigue mandando si se define.
 *
 ...
 */
const PORDEFECTO =
  process.env.NODE_ENV === "production" ? "https://sas.jylartesgraficos.com" : "http://localhost:3000";
